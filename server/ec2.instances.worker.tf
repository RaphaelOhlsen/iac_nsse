module "ec2_worker_instances" {
  ...
  auto_scaling_group = {
    ...
    instance_maintenance_policy = {
      min_healthy_percentage = var.worker_auto_scaling_group.instace_maintenance_policy.min_healthy_percentage
      max_healthy_percentage = var.worker_auto_scaling_group.instace_maintenance_policy.max_healthy_percentage
    }
  }
  tags = var.tags
}
