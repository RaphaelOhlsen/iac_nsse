...
variable "assume_role" {
  ...
  default = {
    role_arn    = "arn:aws:iam::590183756378:role/terraform-role"
    external_id = "c72a3a7f-609f-4997-829f-2b228db6355d"
  }
}
...
variable "vpc_resources" {
  ...
  default = {
    ...
    elastic_ip_nat_gateway_1a = "elastic-ip-nat-gateway-1a"
    elastic_ip_nat_gateway_1b = "elastic-ip-nat-gateway-1b"
